...
public class DeleteAuthenticator extends JPanel implements ActionListener{
    ...
    String ID="";
     ...
     public  DeleteAuthenticator() {
        ...
        setLayout(null);
            ...
            ImageIcon image=new ImageIcon("src\\picture\\left3.jpg");
         ...
         System.out.print(ID);
          ...
          if(ID.equals("")|type.equals(""))
            ...
            try {
                ...
                ResultSet r2=c1.s.executeQuery("select * from users where  a_id ='"+ID+"' ");
                ...
                {
                   String q1="DELETE   from users where  a_id ='"+ID+"' ";
                   c1.s.executeUpdate(q1); 
              
                   
                  
                    String q2="DELETE   from authenticator where  a_id ='"+ID+"' ";
                    c1.s.executeUpdate(q2); 
                 
                    JOptionPane.showMessageDialog(null, "You have Successfully Delete number "+ID+" authenticator");
                    t2.setText("");
    ...
    public void actionPerformed(ActionEvent e) {
     ...
     public static void main(String[] args) {
        ...
        new DeleteAuthenticator().setVisible(true);
	}
