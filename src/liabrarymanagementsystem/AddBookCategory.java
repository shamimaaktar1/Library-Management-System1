...
public class AddBookCategory extends JPanel  implements ActionListener {
                ...
                if(r1.next())
                {
                   ...
                   try{
                      ...
                      if(r3.next()) {
                          ...
                          JOptionPane.showMessageDialog(null, "This book Category already have");
            
                              
                              }
                              else
                              {
                                    String q2="insert into bookcategory values( '"+bk_code+"','"+cat_id+"')";
