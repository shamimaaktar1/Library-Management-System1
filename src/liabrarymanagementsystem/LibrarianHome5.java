...
public class LibrarianHome5 extends JPanel implements ActionListener{
   ...
   setLayout(null);
    ...
    ImageIcon image=new ImageIcon("src\\picture\\d3.png");
    ...
    new LibrarianHome5().setVisible(true);    
    }    
}  
