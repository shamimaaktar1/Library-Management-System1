...
public class UpdateBook extends JPanel  implements ActionListener {
    ...
    public UpdateBook() {
        ...
        JLabel l12 = new JLabel("UPDATE A BOOK");
           ...
           try {
            ...
            try{
             if(r4.next()){
              ...
              String q4="UPDATE book set bk_code='"+bk_code+"',title='"+title+"',pub_id='"+pub_id+"', price='"+ price+"',numofcopy='"+numberofcopy+"',isbn='"+isbn+"',picture='"+picture+"',author='"+author+"' where bk_code='"+bk_code+"' ";
              c1.s.executeUpdate(q4); 

              JOptionPane.showMessageDialog(null, "You have Successfully Update Book Information");
              t1.setText("");
              t3.setText("");
              t2.setText("");
              t5.setText("");
              ...
              // p1.setVisible(true); 
               p1.add(l13);
                 ...
                 JOptionPane.showMessageDialog(null, "This  Book is not in your database");
             }
