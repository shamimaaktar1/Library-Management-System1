...
public class DeleteUser extends JPanel  implements ActionListener {
    ...
    JLabel l1, l2, l3, l4, l5, l6, l7, l8, l9, l12,l13,l14;
    ...
    public DeleteUser() {
        ...
        JLabel l12 = new JLabel("DELETE A USER");
        ...
        l14 = new JLabel("");
        l14.setForeground(new Color(204, 51, 102));
        l14.setFont(new Font("", Font.BOLD, 30));
        l14.setBounds(0, 0, 150, 150);
        p1.add(l14);
    ...
    private void mouseCicked(MouseEvent evt) {
        ...
        if(rb2.isSelected()){ 
           ...
           u_id=t7.getText();
            ...
            ResultSet r1=c1.s.executeQuery("select * from membercard where u_id='"+u_id+"' ");
           
          
            try{
                if(r1.next())
                {
                     String q1="DELETE from membercard where  u_id='"+u_id+"' ";
             ...
             ResultSet r2=c1.s.executeQuery("select * from memberbook where  u_id='"+u_id+"' ");
           try{
            
                    if(r2.next())
                  {
                       String q2="DELETE from memberbook where  u_id='"+u_id+"' ";
          ...
          ResultSet r3=c1.s.executeQuery("select * from reservations where u_id='"+u_id+"' ");
           try{
                        if(r3.next())
                    {
                         String q3="DELETE   from  reservations  where u_id='"+u_id+"' ";
            ...
            try{
                  if(r4.next())
            {
              String q4="Delete users where  u_id ='"+u_id+"' ";
              c1.s.executeUpdate(q4); 

              JOptionPane.showMessageDialog(null, "You have Successfully Delete Users");
              t7.setText("");
              t6.setText("");
              t1.setText("");
              t2.setText("");
