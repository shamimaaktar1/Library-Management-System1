...
public class DeleteBook extends JPanel  implements ActionListener {
    ...
    JTextField t1, t2, t5, t4, t6, t7, t3, t8,t9;
    ...
    private void mouseCicked(MouseEvent evt) {
        ...
        if (evt.getSource() == p2) {
           ...
           try {
            ...
            ResultSet r1=c1.s.executeQuery("select * from bookcategory where bk_code='"+bk_code+"' ");
           
          
            try{
                if(r1.next())
                {
                     String q1="DELETE   from bookcategory where bk_code='"+bk_code+"' ";
             ...
             ResultSet r2=c1.s.executeQuery("select * from memberbook where bk_code='"+bk_code+"' ");
           try{
            
                    if(r2.next())
                  {
                       String q2="DELETE from memberbook where bk_code='"+bk_code+"' ";
          ...
          ResultSet r3=c1.s.executeQuery("select * from reservations where bk_code='"+bk_code+"' ");
           try{
                        if(r3.next())
                    {
                         String q3="DELETE   from  reservations  where bk_code='"+bk_code+"' ";
             ...
             ResultSet r4=c1.s.executeQuery("select * from book where bk_code='"+bk_code+"' ");
            try{
                  if(r4.next())
            {
              String q4="DELETE from book where bk_code='"+bk_code+"' ";
              c1.s.executeUpdate(q4); 

              JOptionPane.showMessageDialog(null, "You have Successfully delete Book");
              t1.setText("");
              t3.setText("");
              t2.setText("");
              t5.setText("");
