...
public class UpdateCategory extends JPanel  implements ActionListener {
          ...
          if(e.getSource()==b1)
     {
        ...
        daily_fine= t4.getText();
         ...
         if(cat_name.equals("")|rent_rate.equals("")|daily_fine.equals(""))
            ...
            ResultSet r1=c1.s.executeQuery("select * from category where  cat_id ='"+cid+"' ");
           
          
            try{
                if(r1.next())
                {
                     String q1="UPDATE category set cat_name='"+cat_name+"',rent_rate='"+rent_rate+"',daily_fine='"+daily_fine+"' where  cat_id ='"+cid+"' ";
