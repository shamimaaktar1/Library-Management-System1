 ...
 * @author Shamima
 */
public class LibararySystem extends JFrame implements ActionListener {
...
/*       home.setBounds(0,60,150,40);
       ...
       side.add(p1);
        ...
        ImageIcon image2=new ImageIcon("src\\picture\\log12.png");
       ...
       // login.b1.addActionListener(this);
        ...
        center.add(Welcomehome, "card1");   
       
         center.add( Login, "card2");
      ...
      // center.add(SearchBook, "card4");
       ...
       Login.p2.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent evt) {
                mouseCicked(evt);
            }
            public void mouseEntered(MouseEvent evt) {
    ...
    private void mouseCicked(MouseEvent evt) { 
        ...
        SearchBook.setVisible(false);
         ...
         try {
            ...
            ResultSet ra=c1.s.executeQuery("select u_id,pasword from users where u_id='"+ID+"' and pasword='"+password+"'" );
            ...
            if(ra.next())  
            {
                ...
                ResultSet r1=c1.s.executeQuery("select * from users where u_id='"+ID+"'" );
                if(r1.next()){
                AID=r1.getString("a_id");
                  ...
                  ResultSet r2=c1.s.executeQuery("select type  from authenticator where a_id='"+AID+"'" );
                  if(r2.next()){
                   ...
                   {
                       JOptionPane.showMessageDialog(null, "Admin Login have Successfully");
                   ...
                   else if(type.compareTo("Librarian")==0)
                       
                   {
                       this.setVisible(false);
                        new Librarian1().setVisible(true);
                        
                       JOptionPane.showMessageDialog(null, "Librarian login  Successfully"); 
                   }
                       ...
                       
                   {
                       this.setVisible(false);
                        ...
                        JOptionPane.showMessageDialog(null, "Member login  Successfully"); 
                   }
           ...
           JOptionPane.showMessageDialog(null, "This UserID or password is wrong"); 
    ...
    public static void main(String[] args) 
    {
        ...
        new LibararySystem().setVisible(true);
    } 
}
