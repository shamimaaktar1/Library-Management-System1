...
public class admin1 extends JFrame implements ActionListener {
    ...
    AdminHome1 home2 =new AdminHome1();
    AdminHome2 home3 =new AdminHome2();
    AdminHome3 home4=new AdminHome3();
...
ShowAllUser  suser = new ShowAllUser();
ShowAllAuthenticator sAuthenticator= new ShowAllAuthenticator();
   // tranp2 tranp2=new tranp2();
...
/*       home.setBounds(0,60,150,40);
       ...
       // login.b1.addActionListener(this);
        ...
        center.add(authenticat, "card2"); 
        center.add( adduser, "card3"); 
        center.add( deleteuser, "card4");      
        center.add( dauthenticat, "card5");
        center.add( uauthenticator , "card6");
        center.add( uuser, "card7");
        center.add( sAuthenticator, "card8");
        center.add( suser, "card9");
        center.add( home2, "card10");
        center.add( home3, "card10");
        center.add( home4, "card11");
    ...
    private void mouseCicked(MouseEvent evt) { 
        ...
        authenticat.setVisible(false);
        adduser.setVisible(false);
       
        deleteuser.setVisible(false);
        dauthenticat.setVisible(false);
        uauthenticator.setVisible(false);
        uuser.setVisible(false);
        suser.setVisible(false);
        sAuthenticator.setVisible(false);
       ...
       if(evt.getSource()==home2.p3){
        ...
        deleteuser.setVisible(false);
        dauthenticat.setVisible(false);
        uauthenticator.setVisible(true);
        uuser.setVisible(false);
        suser.setVisible(false);
        sAuthenticator.setVisible(false);
         ...
         if(evt.getSource()==p7)
     {
        ...
        uuser.setVisible(false);
        suser.setVisible(false);
        sAuthenticator.setVisible(true);
