...
public class LibrarianHome1 extends JPanel implements ActionListener{
   ...
   setLayout(null);
    ...
    ImageIcon image=new ImageIcon("src\\picture\\h11.png");
    ...
    new LibrarianHome1().setVisible(true);    
    }    
}  
