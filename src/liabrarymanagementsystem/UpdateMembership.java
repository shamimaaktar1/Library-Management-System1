...
public class UpdateMembership extends JPanel  implements ActionListener {
        ...
        add(l20);
         ...
         p1= new JPanel();
            ...
            l20.add(p1);
             ...
             JLabel l6 = new JLabel("UPDATE MEMBERSHIP");
...
//       b2.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
         ...
         if(e.getSource()==b2)
        {
         ...
         t1.setText(u_id);
         ((JTextField) dateChooser.getDateEditor().getUiComponent()).setText(issue_date);
         ((JTextField) dateChooser1.getDateEditor().getUiComponent()).setText(exp_date);
          ...
          if(e.getSource()==b1)
     {
         ...
         String issue_date=((JTextField) dateChooser.getDateEditor().getUiComponent()).getText();
         String exp_date= ((JTextField) dateChooser1.getDateEditor().getUiComponent()).getText();
         ...
         try {
            ...
            ResultSet rs=c1.s.executeQuery("select users.u_id,card_no from users,membercard where users.u_id='"+u_id+"' and card_no='"+card_no+"' ");
            
          
            if(rs.next())
            {
                String q1="UPDATE membercard set u_id='"+u_id+"',issue_date='"+issue_date+"',exp_date='"+exp_date+"' where  card_no ='"+card_no+"' ";
                   c1.s.executeUpdate(q1); 
                   JOptionPane.showMessageDialog(null, "You have Successfully Update membership");
               
                
            } 
            
            else{
                JOptionPane.showMessageDialog(null, "UserId or card number is incorrect");
