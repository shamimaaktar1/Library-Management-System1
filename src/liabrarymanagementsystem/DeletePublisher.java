...
public class DeletePublisher extends JPanel  implements ActionListener{
    ...
    String ID;
     ...
     public   DeletePublisher() {
            ...
            p3.setBounds(10,50, 350, 100);
            p3.setLayout(null);
             //l1.add(p3);
             
             
            l11= new JLabel("DELETE PUBLISHER");
            l11.setForeground(new Color(255,0 , 0));
            l11.setFont(new Font("", Font.BOLD, 30));
            l11.setBounds(0, 30, 340, 30);
            //p3.add(l11);
        ...
        address = t5.getText();
         ...
         if(pub_id.equals("")|fname.equals("")|lname.equals("")|phone.equals("")|dateofbirth.equals("")|address.equals(""))
             ...
             Conn c1 =new Conn();
                   ...
                   String q1="DELETE from book where  pub_id ='"+pub_id+"' ";
                   c1.s.executeUpdate(q1);
          
            try{
               
                    String q2="DELETE from publisher where  pub_id ='"+pub_id+"' ";
                   c1.s.executeUpdate(q2); 
                   JOptionPane.showMessageDialog(null, "You have Successfully delete publisher");
    ...
    public void actionPerformed(ActionEvent e) {
     ...
     public static void main(String[] args) {
            new  DeletePublisher().setVisible(true);
	}
