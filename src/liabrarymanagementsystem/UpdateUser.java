...
public class UpdateUser extends JPanel  implements ActionListener {
    ...
    public UpdateUser() {
        ...
        ImageIcon image = new ImageIcon("src\\picture\\b6.jpeg");
        ...
        JLabel l12 = new JLabel("UPDATE A USER");
        ...
        if(rb2.isSelected()){ 
           ...
           try {
            ...
            try{
                  if(r4.next())
            {
               String q4="UPDATE users  set a_id='"+aid+"',fname='"+fname+"',lname='"+lname+"',phone='"+phone+"',dateofbirth='"+dateofbirth+"',addres='"+addres+"',pasword='"+pasword+"',picture='"+picture+"',gender='"+Gender+"'  where  u_id ='"+u_id+"' ";
